...
class ScreenCapture:
    def __init__(self):
        ...
        self._capture_executor = ThreadPoolExecutor(max_workers=1, thread_name_prefix="ScreenCapture")
    ...
    def capture(self, bbox=None, region_key=None):
        ...
        try:
            ...
            if region_key and region_key in self._region_cache:
                ...
                if (cached_monitor['left'] == left and cached_monitor['top'] == top and 
                    cached_monitor['width'] == width and cached_monitor['height'] == height):
